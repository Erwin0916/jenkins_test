...
import com.angkorchat.emoji.cms.domain.studio.emoji.dto.response.StudioArtistEmojiRelatedSite;
...
@Getter
@Setter
public class ModifyStudioEmoji {
    @Schema(hidden = true)
    private Integer id;
    ...
    @Schema(description = "Main Image Url", requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "https://angkorchat-bucket.s3.ap-southeast-1.amazonaws.com/artist/emoji/19/0f9828eda7ec4da1ac5bf59cf8b3c4d6.jpg")
    private String mainEmojiUrl;
    @Schema(description = "Tab Image Url", requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "https://angkorchat-bucket.s3.ap-southeast-1.amazonaws.com/artist/emoji/19/0f9828eda7ec4da1ac5bf59cf8b3c4d6.jpg")
    private String tabImageUrl;
    @Schema(description = "Main Moving Image Url", requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "https://angkorchat-bucket.s3.ap-southeast-1.amazonaws.com/artist/emoji/19/0f9828eda7ec4da1ac5bf59cf8b3c4d6.jpg")
    private String mainMovingEmojiUrl;
    ...
    @Schema(description = "Emoji Files Info", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    List<StudioEmojiRequestDto> emojiFilesInfo;
}
